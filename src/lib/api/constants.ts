...
export const API_ROUTES = {
  ...
  community: {
    ...
    successStoryBySlug: (slug: string) => `/portal/success-stories/slug/${slug}`,
    stories: "/portal/stories",
    myStories: "/portal/stories/me",
...
export const QUERY_KEYS = {
  ...
  community: {
    ...
    successStorySlug: (slug: string) => ["community", "success-stories", "slug", slug] as const,
    myStories: (params?: unknown) => ["community", "stories", "me", params] as const,
