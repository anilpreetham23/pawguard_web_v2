...
import RescueTimeline from "@/features/rescue/RescueTimeline";
import AdoptionCard from "@/features/adoption/AdoptionCard";
import SectionHeading from "@/layouts/SectionHeading";
import Hero from "@/features/hero/hero/Hero";
import { PageShell, Section, Button, Reveal, StaggerGrid, StaggerItem, EditorialHeading } from "@/components/ui/pawguard";
import { Atmosphere, Parallax } from "@/motion";

const EmergencyStory = dynamic(() => import("@/features/rescue/EmergencyStory"), { ssr: false });
const ServicesExperience = dynamic(() => import("@/features/services/services/ServicesExperience"), { ssr: false });
const RescueJourneySection = dynamic(() => import("@/features/rescue/rescue-journey/RescueJourneySection"), { ssr: false });
const CommunityStories = dynamic(() => import("@/components/ui/pawguard").then((mod) => mod.CommunityStories), { ssr: false });
...
import UrgentAlertBanner from "@/features/rescue/UrgentAlertBanner";
...
const STEPS = [
  ...
  { num: "03", title: "Rescue Deployed", desc: "A trained volunteer team en route with live ETA. GPS tracking keeps dispatch and reporters informed.", time: "Priority", color: "#1E3A8A", icon: "team" as const },
