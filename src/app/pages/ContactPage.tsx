  ...
  return (
    <PageShell>
      <main id="main-content" className="flex-1">
        ...
        <DispatchReveal><div className="bg-destructive px-6 lg:px-8 py-4">
        ...
        <Reveal><div className="max-w-[1280px] mx-auto px-6 lg:px-8 pt-section-md lg:pt-section-lg pb-8 grid grid-cols-1 lg:grid-cols-12 gap-[var(--space-12)] lg:gap-[var(--space-16)]">
        ...
        <Reveal><div className="max-w-[1280px] mx-auto px-6 lg:px-8 pt-8 pb-20 lg:pb-28 border-t border-border">
